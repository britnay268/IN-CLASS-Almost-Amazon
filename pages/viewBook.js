...
const viewBook = (obj) => {
  ...
  <div class="mt-5 d-flex flex-wrap">
   <div class="d-flex flex-column">
     ...
     <div class="mt-5">
       <i id="edit-book-btn--${obj.firebaseKey}" class="btn btn-info"><span class="fas fa-edit" id="edit-book-btn--${obj.firebaseKey}"></span></i>
       <i id="delete-book-btn--${obj.firebaseKey}" class="btn btn-danger"><span class="fas fa-trash-alt" id="delete-book-btn--${obj.firebaseKey}"></span></i>
     </div>
   </div>
